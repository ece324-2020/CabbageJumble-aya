...
misc = dict(
    ...
    path_to_imgs = 'data_labelling/david-images',   # "meh_images" ,
    path_to_label = 'data_labelling/david-labels',  # "meh_images_labels",

    # path to save labelled image and txt label respectively:
    path_to_save = "data/david-labelled",
    path_to_save_label = "data/david-labelled",
    border_size = 5
)
